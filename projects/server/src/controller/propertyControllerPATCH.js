        ...
        try {
            ...
            if(images) {
                for(let image of images) {
                    dataImage.push({
                        url: `https://jcwd240203.purwadhikabootcamp.com/Property/${image.filename}`,
                        propertyId: propertyId
                    })
                };
                ...
                for(let image of prevImages) {
                    ...
                    if(image.url.split(`https://jcwd240203.purwadhikabootcamp.com/`)[1]) {
                        old.push({path: 'src/Public/' + image.url.split(`https://jcwd240203.purwadhikabootcamp.com/`)[1]})
                    }
                }
