...
export default function HostProfile(props) {
    return (
        <div className="hostProfile bg-[#F0EFE9] p-[35px] rounded-xl">
            <div className="bg-white p-[20px] rounded-xl drop-shadow-2xl">
                ...
                <div className="flex flex-col justify-center items-start">
                    ...
                    <div className="w-full">
                        <textarea disabled className="w-full h-full bg-transparent overflow-y-auto removeScroll resize-none" value={props?.user?.desc}/>
                    </div>
                </div>
            </div>
        </div>
