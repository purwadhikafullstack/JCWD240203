    ...
    return (
        <div className="flex flex-grow  h-full w-full items-center ">
            <div className="flex justify-between w-full">
                ...
                <div className="locationlist w-[350px] px-[10px] py-[10px] font-bold">
                    {/* status: published/in progress/bebas */}
                    <div className=" text-left ">
                        Kecamatan Mlati, Daerah Istimewa Yogyakarta, Indonesia
                    </div>
                </div>
                {/* <div className="text-[20px] text-white justify-center items-center font-sans h-[45px] w-[100px] rounded-[20px] font-bold bg-green-800/50 cursor-pointer select-none active:scale-95 active:shadow-[0_0px_0_0_#166534,0_0px_0_0_#166534] active:border-b-[0px] transition-all duration-150 shadow-[0_10px_0_0_#166534,0_15px_0_0_] border-b-[1px] drop-shadow-xl hover:bg-green-800/70 py-">
                    edit
                </div> */}
            </div>
